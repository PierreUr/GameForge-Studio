# Aufgabe: ECS-Core: Entity ID-Generator mit Auto-Increment erstellen

## Ziel
Diese Aufgabe implementiert die Kernlogik und Tests fuer 'ECS-Core: Entity ID-Generator mit Auto-Increment erstellen'.

**Modul:** ECS_Core_Engine_Module
**Task-ID:** 002-ecs-core-entity-id-generator-mit-auto-increment-erstellen
**Prioritaet:** Normal
...
3. Wir implementieren: 'ECS-Core: Entity ID-Generator mit Auto-Increment erstellen'
...
2. Teste die Funktion aus Prompt 1: 'ECS-Core: Entity ID-Generator mit Auto-Increment erstellen'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Gueltige Eingaben testet
- Logging implementiert
- EXAKTE Ausgabe erzeugt: [SUCCESS] 002-ecs-core-entity-id-generator-mit-auto-increment-erstellen produced the expected outcome.
...
2. Teste Fehlerbehandlung von 'ECS-Core: Entity ID-Generator mit Auto-Increment erstellen'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Ungueltige Eingaben testet (null, undefined, leere Arrays)
- Exception/Fehler-Rueckgabe erwartet
- EXAKTE Ausgabe: [FAILURE] 002-ecs-core-entity-id-generator-mit-auto-increment-erstellen correctly handled invalid input.
