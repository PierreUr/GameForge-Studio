# Aufgabe: ECS-Core: Entity-Set fuer aktive Entities verwalten

## Ziel
Diese Aufgabe implementiert die Kernlogik und Tests fuer 'ECS-Core: Entity-Set fuer aktive Entities verwalten'.

**Modul:** ECS_Core_Engine_Module
**Task-ID:** 003-ecs-core-entity-set-fuer-aktive-entities-verwalten
**Prioritaet:** Normal
...
3. Wir implementieren: 'ECS-Core: Entity-Set fuer aktive Entities verwalten'
...
2. Teste die Funktion aus Prompt 1: 'ECS-Core: Entity-Set fuer aktive Entities verwalten'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Gueltige Eingaben testet
- Logging implementiert
- EXAKTE Ausgabe erzeugt: [SUCCESS] 003-ecs-core-entity-set-fuer-aktive-entities-verwalten produced the expected outcome.
...
2. Teste Fehlerbehandlung von 'ECS-Core: Entity-Set fuer aktive Entities verwalten'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Ungueltige Eingaben testet (null, undefined, leere Arrays)
- Exception/Fehler-Rueckgabe erwartet
- EXAKTE Ausgabe: [FAILURE] 003-ecs-core-entity-set-fuer-aktive-entities-verwalten correctly handled invalid input.
