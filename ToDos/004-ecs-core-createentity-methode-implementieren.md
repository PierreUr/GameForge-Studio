# Aufgabe: ECS-Core: createEntity() Methode implementieren

## Ziel
Diese Aufgabe implementiert die Kernlogik und Tests fuer 'ECS-Core: createEntity() Methode implementieren'.

**Modul:** ECS_Core_Engine_Module
**Task-ID:** 004-ecs-core-createentity-methode-implementieren
**Prioritaet:** Normal
...
3. Wir implementieren: 'ECS-Core: createEntity() Methode implementieren'
...
2. Teste die Funktion aus Prompt 1: 'ECS-Core: createEntity() Methode implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Gueltige Eingaben testet
- Logging implementiert
- EXAKTE Ausgabe erzeugt: [SUCCESS] 004-ecs-core-createentity-methode-implementieren produced the expected outcome.
...
2. Teste Fehlerbehandlung von 'ECS-Core: createEntity() Methode implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Ungueltige Eingaben testet (null, undefined, leere Arrays)
- Exception/Fehler-Rueckgabe erwartet
- EXAKTE Ausgabe: [FAILURE] 004-ecs-core-createentity-methode-implementieren correctly handled invalid input.
