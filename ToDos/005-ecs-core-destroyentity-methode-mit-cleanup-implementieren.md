# Aufgabe: ECS-Core: destroyEntity() Methode mit Cleanup implementieren

## Ziel
Diese Aufgabe implementiert die Kernlogik und Tests fuer 'ECS-Core: destroyEntity() Methode mit Cleanup implementieren'.

**Modul:** ECS_Core_Engine_Module
**Task-ID:** 005-ecs-core-destroyentity-methode-mit-cleanup-implementieren
**Prioritaet:** Normal
...
3. Wir implementieren: 'ECS-Core: destroyEntity() Methode mit Cleanup implementieren'
...
2. Teste die Funktion aus Prompt 1: 'ECS-Core: destroyEntity() Methode mit Cleanup implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Gueltige Eingaben testet
- Logging implementiert
- EXAKTE Ausgabe erzeugt: [SUCCESS] 005-ecs-core-destroyentity-methode-mit-cleanup-implementieren produced the expected outcome.
...
2. Teste Fehlerbehandlung von 'ECS-Core: destroyEntity() Methode mit Cleanup implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Ungueltige Eingaben testet (null, undefined, leere Arrays)
- Exception/Fehler-Rueckgabe erwartet
- EXAKTE Ausgabe: [FAILURE] 005-ecs-core-destroyentity-methode-mit-cleanup-implementieren correctly handled invalid input.
