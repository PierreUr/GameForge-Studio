# Aufgabe: ECS-Core: ComponentManager Basisklasse implementieren

## Ziel
Diese Aufgabe implementiert die Kernlogik und Tests fuer 'ECS-Core: ComponentManager Basisklasse implementieren'.

**Modul:** ECS_Core_Engine_Module
**Task-ID:** 006-ecs-core-componentmanager-basisklasse-implementieren
**Prioritaet:** Normal
...
3. Wir implementieren: 'ECS-Core: ComponentManager Basisklasse implementieren'
...
2. Teste die Funktion aus Prompt 1: 'ECS-Core: ComponentManager Basisklasse implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Gueltige Eingaben testet
- Logging implementiert
- EXAKTE Ausgabe erzeugt: [SUCCESS] 006-ecs-core-componentmanager-basisklasse-implementieren produced the expected outcome.
...
2. Teste Fehlerbehandlung von 'ECS-Core: ComponentManager Basisklasse implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Ungueltige Eingaben testet (null, undefined, leere Arrays)
- Exception/Fehler-Rueckgabe erwartet
- EXAKTE Ausgabe: [FAILURE] 006-ecs-core-componentmanager-basisklasse-implementieren correctly handled invalid input.
