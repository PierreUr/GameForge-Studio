# Aufgabe: ECS-Core: ComponentStores Map-Datenstruktur erstellen

## Ziel
Diese Aufgabe implementiert die Kernlogik und Tests fuer 'ECS-Core: ComponentStores Map-Datenstruktur erstellen'.

**Modul:** ECS_Core_Engine_Module
**Task-ID:** 007-ecs-core-componentstores-map-datenstruktur-erstellen
**Prioritaet:** Normal
...
3. Wir implementieren: 'ECS-Core: ComponentStores Map-Datenstruktur erstellen'
...
2. Teste die Funktion aus Prompt 1: 'ECS-Core: ComponentStores Map-Datenstruktur erstellen'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Gueltige Eingaben testet
- Logging implementiert
- EXAKTE Ausgabe erzeugt: [SUCCESS] 007-ecs-core-componentstores-map-datenstruktur-erstellen produced the expected outcome.
...
2. Teste Fehlerbehandlung von 'ECS-Core: ComponentStores Map-Datenstruktur erstellen'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Ungueltige Eingaben testet (null, undefined, leere Arrays)
- Exception/Fehler-Rueckgabe erwartet
- EXAKTE Ausgabe: [FAILURE] 007-ecs-core-componentstores-map-datenstruktur-erstellen correctly handled invalid input.
