# Aufgabe: ECS-Core: getEntitiesWithComponents() Query-System implementieren

## Ziel
Diese Aufgabe implementiert die Kernlogik und Tests fuer 'ECS-Core: getEntitiesWithComponents() Query-System implementieren'.

**Modul:** ECS_Core_Engine_Module
**Task-ID:** 011-ecs-core-getentitieswithcomponents-query-system-implementieren
**Prioritaet:** Normal
...
3. Wir implementieren: 'ECS-Core: getEntitiesWithComponents() Query-System implementieren'
...
2. Teste die Funktion aus Prompt 1: 'ECS-Core: getEntitiesWithComponents() Query-System implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Gueltige Eingaben testet
- Logging implementiert
- EXAKTE Ausgabe erzeugt: [SUCCESS] 011-ecs-core-getentitieswithcomponents-query-system-implementieren produced the expected outcome.
...
2. Teste Fehlerbehandlung von 'ECS-Core: getEntitiesWithComponents() Query-System implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Ungueltige Eingaben testet (null, undefined, leere Arrays)
- Exception/Fehler-Rueckgabe erwartet
- EXAKTE Ausgabe: [FAILURE] 011-ecs-core-getentitieswithcomponents-query-system-implementieren correctly handled invalid input.
