# Aufgabe: ECS-Core: Component isActive-Flag Unterstuetzung implementieren

## Ziel
Diese Aufgabe implementiert die Kernlogik und Tests fuer 'ECS-Core: Component isActive-Flag Unterstuetzung implementieren'.

**Modul:** ECS_Core_Engine_Module
**Task-ID:** 012-ecs-core-component-isactive-flag-unterstuetzung-implementieren
**Prioritaet:** Normal
...
3. Wir implementieren: 'ECS-Core: Component isActive-Flag Unterstuetzung implementieren'
...
2. Teste die Funktion aus Prompt 1: 'ECS-Core: Component isActive-Flag Unterstuetzung implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Gueltige Eingaben testet
- Logging implementiert
- EXAKTE Ausgabe erzeugt: [SUCCESS] 012-ecs-core-component-isactive-flag-unterstuetzung-implementieren produced the expected outcome.
...
2. Teste Fehlerbehandlung von 'ECS-Core: Component isActive-Flag Unterstuetzung implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Ungueltige Eingaben testet (null, undefined, leere Arrays)
- Exception/Fehler-Rueckgabe erwartet
- EXAKTE Ausgabe: [FAILURE] 012-ecs-core-component-isactive-flag-unterstuetzung-implementieren correctly handled invalid input.
