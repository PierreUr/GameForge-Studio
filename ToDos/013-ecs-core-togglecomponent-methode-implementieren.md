# Aufgabe: ECS-Core: toggleComponent() Methode implementieren

## Ziel
Diese Aufgabe implementiert die Kernlogik und Tests fuer 'ECS-Core: toggleComponent() Methode implementieren'.

**Modul:** ECS_Core_Engine_Module
**Task-ID:** 013-ecs-core-togglecomponent-methode-implementieren
**Prioritaet:** Normal
...
3. Wir implementieren: 'ECS-Core: toggleComponent() Methode implementieren'
...
2. Teste die Funktion aus Prompt 1: 'ECS-Core: toggleComponent() Methode implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Gueltige Eingaben testet
- Logging implementiert
- EXAKTE Ausgabe erzeugt: [SUCCESS] 013-ecs-core-togglecomponent-methode-implementieren produced the expected outcome.
...
2. Teste Fehlerbehandlung von 'ECS-Core: toggleComponent() Methode implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Ungueltige Eingaben testet (null, undefined, leere Arrays)
- Exception/Fehler-Rueckgabe erwartet
- EXAKTE Ausgabe: [FAILURE] 013-ecs-core-togglecomponent-methode-implementieren correctly handled invalid input.
