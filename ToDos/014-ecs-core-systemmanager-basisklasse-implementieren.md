# Aufgabe: ECS-Core: SystemManager Basisklasse implementieren

## Ziel
Diese Aufgabe implementiert die Kernlogik und Tests fuer 'ECS-Core: SystemManager Basisklasse implementieren'.

**Modul:** ECS_Core_Engine_Module
**Task-ID:** 014-ecs-core-systemmanager-basisklasse-implementieren
**Prioritaet:** Normal
...
3. Wir implementieren: 'ECS-Core: SystemManager Basisklasse implementieren'
...
2. Teste die Funktion aus Prompt 1: 'ECS-Core: SystemManager Basisklasse implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Gueltige Eingaben testet
- Logging implementiert
- EXAKTE Ausgabe erzeugt: [SUCCESS] 014-ecs-core-systemmanager-basisklasse-implementieren produced the expected outcome.
...
2. Teste Fehlerbehandlung von 'ECS-Core: SystemManager Basisklasse implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Ungueltige Eingaben testet (null, undefined, leere Arrays)
- Exception/Fehler-Rueckgabe erwartet
- EXAKTE Ausgabe: [FAILURE] 014-ecs-core-systemmanager-basisklasse-implementieren correctly handled invalid input.
