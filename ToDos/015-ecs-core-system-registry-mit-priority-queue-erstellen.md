# Aufgabe: ECS-Core: System-Registry mit Priority-Queue erstellen

## Ziel
Diese Aufgabe implementiert die Kernlogik und Tests fuer 'ECS-Core: System-Registry mit Priority-Queue erstellen'.

**Modul:** ECS_Core_Engine_Module
**Task-ID:** 015-ecs-core-system-registry-mit-priority-queue-erstellen
**Prioritaet:** Normal
...
3. Wir implementieren: 'ECS-Core: System-Registry mit Priority-Queue erstellen'
...
2. Teste die Funktion aus Prompt 1: 'ECS-Core: System-Registry mit Priority-Queue erstellen'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Gueltige Eingaben testet
- Logging implementiert
- EXAKTE Ausgabe erzeugt: [SUCCESS] 015-ecs-core-system-registry-mit-priority-queue-erstellen produced the expected outcome.
...
2. Teste Fehlerbehandlung von 'ECS-Core: System-Registry mit Priority-Queue erstellen'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Ungueltige Eingaben testet (null, undefined, leere Arrays)
- Exception/Fehler-Rueckgabe erwartet
- EXAKTE Ausgabe: [FAILURE] 015-ecs-core-system-registry-mit-priority-queue-erstellen correctly handled invalid input.
