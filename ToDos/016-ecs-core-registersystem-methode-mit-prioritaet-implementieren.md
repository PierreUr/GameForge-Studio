# Aufgabe: ECS-Core: registerSystem() Methode mit Prioritaet implementieren

## Ziel
Diese Aufgabe implementiert die Kernlogik und Tests fuer 'ECS-Core: registerSystem() Methode mit Prioritaet implementieren'.

**Modul:** ECS_Core_Engine_Module
**Task-ID:** 016-ecs-core-registersystem-methode-mit-prioritaet-implementieren
**Prioritaet:** Normal
...
3. Wir implementieren: 'ECS-Core: registerSystem() Methode mit Prioritaet implementieren'
...
2. Teste die Funktion aus Prompt 1: 'ECS-Core: registerSystem() Methode mit Prioritaet implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Gueltige Eingaben testet
- Logging implementiert
- EXAKTE Ausgabe erzeugt: [SUCCESS] 016-ecs-core-registersystem-methode-mit-prioritaet-implementieren produced the expected outcome.
...
2. Teste Fehlerbehandlung von 'ECS-Core: registerSystem() Methode mit Prioritaet implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Ungueltige Eingaben testet (null, undefined, leere Arrays)
- Exception/Fehler-Rueckgabe erwartet
- EXAKTE Ausgabe: [FAILURE] 016-ecs-core-registersystem-methode-mit-prioritaet-implementieren correctly handled invalid input.
