# Aufgabe: ECS-Core: unregisterSystem() Methode implementieren

## Ziel
Diese Aufgabe implementiert die Kernlogik und Tests fuer 'ECS-Core: unregisterSystem() Methode implementieren'.

**Modul:** ECS_Core_Engine_Module
**Task-ID:** 017-ecs-core-unregistersystem-methode-implementieren
**Prioritaet:** Normal
...
3. Wir implementieren: 'ECS-Core: unregisterSystem() Methode implementieren'
...
2. Teste die Funktion aus Prompt 1: 'ECS-Core: unregisterSystem() Methode implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Gueltige Eingaben testet
- Logging implementiert
- EXAKTE Ausgabe erzeugt: [SUCCESS] 017-ecs-core-unregistersystem-methode-implementieren produced the expected outcome.
...
2. Teste Fehlerbehandlung von 'ECS-Core: unregisterSystem() Methode implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Ungueltige Eingaben testet (null, undefined, leere Arrays)
- Exception/Fehler-Rueckgabe erwartet
- EXAKTE Ausgabe: [FAILURE] 017-ecs-core-unregistersystem-methode-implementieren correctly handled invalid input.
