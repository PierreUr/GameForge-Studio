# Aufgabe: ECS-Core: toggleSystem() fuer globales Pausieren implementieren

## Ziel
Diese Aufgabe implementiert die Kernlogik und Tests fuer 'ECS-Core: toggleSystem() fuer globales Pausieren implementieren'.

**Modul:** ECS_Core_Engine_Module
**Task-ID:** 018-ecs-core-togglesystem-fuer-globales-pausieren-implementieren
**Prioritaet:** Normal
...
3. Wir implementieren: 'ECS-Core: toggleSystem() fuer globales Pausieren implementieren'
...
2. Teste die Funktion aus Prompt 1: 'ECS-Core: toggleSystem() fuer globales Pausieren implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Gueltige Eingaben testet
- Logging implementiert
- EXAKTE Ausgabe erzeugt: [SUCCESS] 018-ecs-core-togglesystem-fuer-globales-pausieren-implementieren produced the expected outcome.
...
2. Teste Fehlerbehandlung von 'ECS-Core: toggleSystem() fuer globales Pausieren implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Ungueltige Eingaben testet (null, undefined, leere Arrays)
- Exception/Fehler-Rueckgabe erwartet
- EXAKTE Ausgabe: [FAILURE] 018-ecs-core-togglesystem-fuer-globales-pausieren-implementieren correctly handled invalid input.
