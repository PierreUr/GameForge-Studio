# Aufgabe: ECS-Core: DeltaTime-Berechnung fuer GameLoop implementieren

## Ziel
Diese Aufgabe implementiert die Kernlogik und Tests fuer 'ECS-Core: DeltaTime-Berechnung fuer GameLoop implementieren'.

**Modul:** ECS_Core_Engine_Module
**Task-ID:** 020-ecs-core-deltatime-berechnung-fuer-gameloop-implementieren
**Prioritaet:** Normal
...
3. Wir implementieren: 'ECS-Core: DeltaTime-Berechnung fuer GameLoop implementieren'
...
2. Teste die Funktion aus Prompt 1: 'ECS-Core: DeltaTime-Berechnung fuer GameLoop implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Gueltige Eingaben testet
- Logging implementiert
- EXAKTE Ausgabe erzeugt: [SUCCESS] 020-ecs-core-deltatime-berechnung-fuer-gameloop-implementieren produced the expected outcome.
...
2. Teste Fehlerbehandlung von 'ECS-Core: DeltaTime-Berechnung fuer GameLoop implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Ungueltige Eingaben testet (null, undefined, leere Arrays)
- Exception/Fehler-Rueckgabe erwartet
- EXAKTE Ausgabe: [FAILURE] 020-ecs-core-deltatime-berechnung-fuer-gameloop-implementieren correctly handled invalid input.
