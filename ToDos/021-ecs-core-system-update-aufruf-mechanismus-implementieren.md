# Aufgabe: ECS-Core: System.update() Aufruf-Mechanismus implementieren

## Ziel
Diese Aufgabe implementiert die Kernlogik und Tests fuer 'ECS-Core: System.update() Aufruf-Mechanismus implementieren'.

**Modul:** ECS_Core_Engine_Module
**Task-ID:** 021-ecs-core-system-update-aufruf-mechanismus-implementieren
**Prioritaet:** Normal
...
3. Wir implementieren: 'ECS-Core: System.update() Aufruf-Mechanismus implementieren'
...
2. Teste die Funktion aus Prompt 1: 'ECS-Core: System.update() Aufruf-Mechanismus implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Gueltige Eingaben testet
- Logging implementiert
- EXAKTE Ausgabe erzeugt: [SUCCESS] 021-ecs-core-system-update-aufruf-mechanismus-implementieren produced the expected outcome.
...
2. Teste Fehlerbehandlung von 'ECS-Core: System.update() Aufruf-Mechanismus implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Ungueltige Eingaben testet (null, undefined, leere Arrays)
- Exception/Fehler-Rueckgabe erwartet
- EXAKTE Ausgabe: [FAILURE] 021-ecs-core-system-update-aufruf-mechanismus-implementieren correctly handled invalid input.
