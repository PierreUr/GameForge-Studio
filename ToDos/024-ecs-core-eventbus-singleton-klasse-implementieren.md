# Aufgabe: ECS-Core: EventBus Singleton-Klasse implementieren

## Ziel
Diese Aufgabe implementiert die Kernlogik und Tests fuer 'ECS-Core: EventBus Singleton-Klasse implementieren'.

**Modul:** ECS_Core_Engine_Module
**Task-ID:** 024-ecs-core-eventbus-singleton-klasse-implementieren
**Prioritaet:** Normal
...
3. Wir implementieren: 'ECS-Core: EventBus Singleton-Klasse implementieren'
...
2. Teste die Funktion aus Prompt 1: 'ECS-Core: EventBus Singleton-Klasse implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Gueltige Eingaben testet
- Logging implementiert
- EXAKTE Ausgabe erzeugt: [SUCCESS] 024-ecs-core-eventbus-singleton-klasse-implementieren produced the expected outcome.
...
2. Teste Fehlerbehandlung von 'ECS-Core: EventBus Singleton-Klasse implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Ungueltige Eingaben testet (null, undefined, leere Arrays)
- Exception/Fehler-Rueckgabe erwartet
- EXAKTE Ausgabe: [FAILURE] 024-ecs-core-eventbus-singleton-klasse-implementieren correctly handled invalid input.
