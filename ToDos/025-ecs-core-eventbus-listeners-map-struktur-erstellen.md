# Aufgabe: ECS-Core: EventBus Listeners Map-Struktur erstellen

## Ziel
Diese Aufgabe implementiert die Kernlogik und Tests fuer 'ECS-Core: EventBus Listeners Map-Struktur erstellen'.

**Modul:** ECS_Core_Engine_Module
**Task-ID:** 025-ecs-core-eventbus-listeners-map-struktur-erstellen
**Prioritaet:** Normal
...
3. Wir implementieren: 'ECS-Core: EventBus Listeners Map-Struktur erstellen'
...
2. Teste die Funktion aus Prompt 1: 'ECS-Core: EventBus Listeners Map-Struktur erstellen'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Gueltige Eingaben testet
- Logging implementiert
- EXAKTE Ausgabe erzeugt: [SUCCESS] 025-ecs-core-eventbus-listeners-map-struktur-erstellen produced the expected outcome.
...
2. Teste Fehlerbehandlung von 'ECS-Core: EventBus Listeners Map-Struktur erstellen'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Ungueltige Eingaben testet (null, undefined, leere Arrays)
- Exception/Fehler-Rueckgabe erwartet
- EXAKTE Ausgabe: [FAILURE] 025-ecs-core-eventbus-listeners-map-struktur-erstellen correctly handled invalid input.
