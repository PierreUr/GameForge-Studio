# Aufgabe: Library: Component Basisklasse mit isActive erstellen

## Ziel
Diese Aufgabe implementiert die Kernlogik und Tests fuer 'Library: Component Basisklasse mit isActive erstellen'.

**Modul:** Core_Function_Library_Module
**Task-ID:** 032-library-component-basisklasse-mit-isactive-erstellen
**Prioritaet:** Normal
...
3. Wir implementieren: 'Library: Component Basisklasse mit isActive erstellen'
...
2. Teste die Funktion aus Prompt 1: 'Library: Component Basisklasse mit isActive erstellen'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Gueltige Eingaben testet
- Logging implementiert
- EXAKTE Ausgabe erzeugt: [SUCCESS] 032-library-component-basisklasse-mit-isactive-erstellen produced the expected outcome.
...
2. Teste Fehlerbehandlung von 'Library: Component Basisklasse mit isActive erstellen'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Ungueltige Eingaben testet (null, undefined, leere Arrays)
- Exception/Fehler-Rueckgabe erwartet
- EXAKTE Ausgabe: [FAILURE] 032-library-component-basisklasse-mit-isactive-erstellen correctly handled invalid input.
