# Aufgabe: Library: VelocityComponent (x, y) implementieren

## Ziel
Diese Aufgabe implementiert die Kernlogik und Tests fuer 'Library: VelocityComponent (x, y) implementieren'.

**Modul:** Core_Function_Library_Module
**Task-ID:** 035-library-velocitycomponent-x-y-implementieren
**Prioritaet:** Normal
...
3. Wir implementieren: 'Library: VelocityComponent (x, y) implementieren'
...
2. Teste die Funktion aus Prompt 1: 'Library: VelocityComponent (x, y) implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Gueltige Eingaben testet
- Logging implementiert
- EXAKTE Ausgabe erzeugt: [SUCCESS] 035-library-velocitycomponent-x-y-implementieren produced the expected outcome.
...
2. Teste Fehlerbehandlung von 'Library: VelocityComponent (x, y) implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Ungueltige Eingaben testet (null, undefined, leere Arrays)
- Exception/Fehler-Rueckgabe erwartet
- EXAKTE Ausgabe: [FAILURE] 035-library-velocitycomponent-x-y-implementieren correctly handled invalid input.
