# Aufgabe: Library: SpriteComponent (texture, width, height) implementieren

## Ziel
Diese Aufgabe implementiert die Kernlogik und Tests fuer 'Library: SpriteComponent (texture, width, height) implementieren'.

**Modul:** Core_Function_Library_Module
**Task-ID:** 036-library-spritecomponent-texture-width-height-implementieren
**Prioritaet:** Normal
...
3. Wir implementieren: 'Library: SpriteComponent (texture, width, height) implementieren'
...
2. Teste die Funktion aus Prompt 1: 'Library: SpriteComponent (texture, width, height) implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Gueltige Eingaben testet
- Logging implementiert
- EXAKTE Ausgabe erzeugt: [SUCCESS] 036-library-spritecomponent-texture-width-height-implementieren produced the expected outcome.
...
2. Teste Fehlerbehandlung von 'Library: SpriteComponent (texture, width, height) implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Ungueltige Eingaben testet (null, undefined, leere Arrays)
- Exception/Fehler-Rueckgabe erwartet
- EXAKTE Ausgabe: [FAILURE] 036-library-spritecomponent-texture-width-height-implementieren correctly handled invalid input.
