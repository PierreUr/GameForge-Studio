# Aufgabe: Library: HealthComponent (max, current) implementieren

## Ziel
Diese Aufgabe implementiert die Kernlogik und Tests fuer 'Library: HealthComponent (max, current) implementieren'.

**Modul:** Core_Function_Library_Module
**Task-ID:** 037-library-healthcomponent-max-current-implementieren
**Prioritaet:** Normal
...
3. Wir implementieren: 'Library: HealthComponent (max, current) implementieren'
...
2. Teste die Funktion aus Prompt 1: 'Library: HealthComponent (max, current) implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Gueltige Eingaben testet
- Logging implementiert
- EXAKTE Ausgabe erzeugt: [SUCCESS] 037-library-healthcomponent-max-current-implementieren produced the expected outcome.
...
2. Teste Fehlerbehandlung von 'Library: HealthComponent (max, current) implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Ungueltige Eingaben testet (null, undefined, leere Arrays)
- Exception/Fehler-Rueckgabe erwartet
- EXAKTE Ausgabe: [FAILURE] 037-library-healthcomponent-max-current-implementieren correctly handled invalid input.
