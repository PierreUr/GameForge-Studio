# Aufgabe: Library: PlayerInputComponent (keyBindings) implementieren

## Ziel
Diese Aufgabe implementiert die Kernlogik und Tests fuer 'Library: PlayerInputComponent (keyBindings) implementieren'.

**Modul:** Core_Function_Library_Module
**Task-ID:** 038-library-playerinputcomponent-keybindings-implementieren
**Prioritaet:** Normal
...
3. Wir implementieren: 'Library: PlayerInputComponent (keyBindings) implementieren'
...
2. Teste die Funktion aus Prompt 1: 'Library: PlayerInputComponent (keyBindings) implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Gueltige Eingaben testet
- Logging implementiert
- EXAKTE Ausgabe erzeugt: [SUCCESS] 038-library-playerinputcomponent-keybindings-implementieren produced the expected outcome.
...
2. Teste Fehlerbehandlung von 'Library: PlayerInputComponent (keyBindings) implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Ungueltige Eingaben testet (null, undefined, leere Arrays)
- Exception/Fehler-Rueckgabe erwartet
- EXAKTE Ausgabe: [FAILURE] 038-library-playerinputcomponent-keybindings-implementieren correctly handled invalid input.
