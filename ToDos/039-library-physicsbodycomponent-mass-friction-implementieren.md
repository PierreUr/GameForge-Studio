# Aufgabe: Library: PhysicsBodyComponent (mass, friction) implementieren

## Ziel
Diese Aufgabe implementiert die Kernlogik und Tests fuer 'Library: PhysicsBodyComponent (mass, friction) implementieren'.

**Modul:** Core_Function_Library_Module
**Task-ID:** 039-library-physicsbodycomponent-mass-friction-implementieren
**Prioritaet:** Normal
...
3. Wir implementieren: 'Library: PhysicsBodyComponent (mass, friction) implementieren'
...
2. Teste die Funktion aus Prompt 1: 'Library: PhysicsBodyComponent (mass, friction) implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Gueltige Eingaben testet
- Logging implementiert
- EXAKTE Ausgabe erzeugt: [SUCCESS] 039-library-physicsbodycomponent-mass-friction-implementieren produced the expected outcome.
...
2. Teste Fehlerbehandlung von 'Library: PhysicsBodyComponent (mass, friction) implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Ungueltige Eingaben testet (null, undefined, leere Arrays)
- Exception/Fehler-Rueckgabe erwartet
- EXAKTE Ausgabe: [FAILURE] 039-library-physicsbodycomponent-mass-friction-implementieren correctly handled invalid input.
