# Aufgabe: Library: AIPatrolComponent (waypoints, speed) implementieren

## Ziel
Diese Aufgabe implementiert die Kernlogik und Tests fuer 'Library: AIPatrolComponent (waypoints, speed) implementieren'.

**Modul:** Core_Function_Library_Module
**Task-ID:** 042-library-aipatrolcomponent-waypoints-speed-implementieren
**Prioritaet:** Normal
...
3. Wir implementieren: 'Library: AIPatrolComponent (waypoints, speed) implementieren'
...
2. Teste die Funktion aus Prompt 1: 'Library: AIPatrolComponent (waypoints, speed) implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Gueltige Eingaben testet
- Logging implementiert
- EXAKTE Ausgabe erzeugt: [SUCCESS] 042-library-aipatrolcomponent-waypoints-speed-implementieren produced the expected outcome.
...
2. Teste Fehlerbehandlung von 'Library: AIPatrolComponent (waypoints, speed) implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Ungueltige Eingaben testet (null, undefined, leere Arrays)
- Exception/Fehler-Rueckgabe erwartet
- EXAKTE Ausgabe: [FAILURE] 042-library-aipatrolcomponent-waypoints-speed-implementieren correctly handled invalid input.
