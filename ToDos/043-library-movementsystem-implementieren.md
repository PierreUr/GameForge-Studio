# Aufgabe: Library: MovementSystem implementieren

## Ziel
Diese Aufgabe implementiert die Kernlogik und Tests fuer 'Library: MovementSystem implementieren'.

**Modul:** Core_Function_Library_Module
**Task-ID:** 043-library-movementsystem-implementieren
**Prioritaet:** Normal
...
3. Wir implementieren: 'Library: MovementSystem implementieren'
...
2. Teste die Funktion aus Prompt 1: 'Library: MovementSystem implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Gueltige Eingaben testet
- Logging implementiert
- EXAKTE Ausgabe erzeugt: [SUCCESS] 043-library-movementsystem-implementieren produced the expected outcome.
...
2. Teste Fehlerbehandlung von 'Library: MovementSystem implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Ungueltige Eingaben testet (null, undefined, leere Arrays)
- Exception/Fehler-Rueckgabe erwartet
- EXAKTE Ausgabe: [FAILURE] 043-library-movementsystem-implementieren correctly handled invalid input.
