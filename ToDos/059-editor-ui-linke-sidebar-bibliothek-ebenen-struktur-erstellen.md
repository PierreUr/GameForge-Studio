# Aufgabe: Editor-UI: Linke Sidebar (Bibliothek + Ebenen) Struktur erstellen

## Ziel
Diese Aufgabe implementiert die Kernlogik und Tests fuer 'Editor-UI: Linke Sidebar (Bibliothek + Ebenen) Struktur erstellen'.

**Modul:** UI_Editor_Module
**Task-ID:** 059-editor-ui-linke-sidebar-bibliothek-ebenen-struktur-erstellen
**Prioritaet:** Normal
...
3. Wir implementieren: 'Editor-UI: Linke Sidebar (Bibliothek + Ebenen) Struktur erstellen'
...
2. Teste die Funktion aus Prompt 1: 'Editor-UI: Linke Sidebar (Bibliothek + Ebenen) Struktur erstellen'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Gueltige Eingaben testet
- Logging implementiert
- EXAKTE Ausgabe erzeugt: [SUCCESS] 059-editor-ui-linke-sidebar-bibliothek-ebenen-struktur-erstellen produced the expected outcome.
...
2. Teste Fehlerbehandlung von 'Editor-UI: Linke Sidebar (Bibliothek + Ebenen) Struktur erstellen'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Ungueltige Eingaben testet (null, undefined, leere Arrays)
- Exception/Fehler-Rueckgabe erwartet
- EXAKTE Ausgabe: [FAILURE] 059-editor-ui-linke-sidebar-bibliothek-ebenen-struktur-erstellen correctly handled invalid input.
