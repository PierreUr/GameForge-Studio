# Aufgabe: Editor-UI: Rechte Sidebar (Inspektor) Struktur erstellen

## Ziel
Diese Aufgabe implementiert die Kernlogik und Tests fuer 'Editor-UI: Rechte Sidebar (Inspektor) Struktur erstellen'.

**Modul:** UI_Editor_Module
**Task-ID:** 060-editor-ui-rechte-sidebar-inspektor-struktur-erstellen
**Prioritaet:** Normal
...
3. Wir implementieren: 'Editor-UI: Rechte Sidebar (Inspektor) Struktur erstellen'
...
2. Teste die Funktion aus Prompt 1: 'Editor-UI: Rechte Sidebar (Inspektor) Struktur erstellen'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Gueltige Eingaben testet
- Logging implementiert
- EXAKTE Ausgabe erzeugt: [SUCCESS] 060-editor-ui-rechte-sidebar-inspektor-struktur-erstellen produced the expected outcome.
...
2. Teste Fehlerbehandlung von 'Editor-UI: Rechte Sidebar (Inspektor) Struktur erstellen'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Ungueltige Eingaben testet (null, undefined, leere Arrays)
- Exception/Fehler-Rueckgabe erwartet
- EXAKTE Ausgabe: [FAILURE] 060-editor-ui-rechte-sidebar-inspektor-struktur-erstellen correctly handled invalid input.
