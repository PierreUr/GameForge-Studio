# Aufgabe: Editor-UI: Drop-Koordinaten Canvas-lokal umrechnen

## Ziel
Diese Aufgabe implementiert die Kernlogik und Tests fuer 'Editor-UI: Drop-Koordinaten Canvas-lokal umrechnen'.

**Modul:** UI_Editor_Module
**Task-ID:** 072-editor-ui-drop-koordinaten-canvas-lokal-umrechnen
**Prioritaet:** Normal
...
3. Wir implementieren: 'Editor-UI: Drop-Koordinaten Canvas-lokal umrechnen'
...
2. Teste die Funktion aus Prompt 1: 'Editor-UI: Drop-Koordinaten Canvas-lokal umrechnen'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Gueltige Eingaben testet
- Logging implementiert
- EXAKTE Ausgabe erzeugt: [SUCCESS] 072-editor-ui-drop-koordinaten-canvas-lokal-umrechnen produced the expected outcome.
...
2. Teste Fehlerbehandlung von 'Editor-UI: Drop-Koordinaten Canvas-lokal umrechnen'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Ungueltige Eingaben testet (null, undefined, leere Arrays)
- Exception/Fehler-Rueckgabe erwartet
- EXAKTE Ausgabe: [FAILURE] 072-editor-ui-drop-koordinaten-canvas-lokal-umrechnen correctly handled invalid input.
