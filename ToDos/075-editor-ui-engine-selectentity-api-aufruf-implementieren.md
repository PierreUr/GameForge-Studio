# Aufgabe: Editor-UI: engine.selectEntity() API-Aufruf implementieren

## Ziel
Diese Aufgabe implementiert die Kernlogik und Tests fuer 'Editor-UI: engine.selectEntity() API-Aufruf implementieren'.

**Modul:** UI_Editor_Module
**Task-ID:** 075-editor-ui-engine-selectentity-api-aufruf-implementieren
**Prioritaet:** Normal
...
3. Wir implementieren: 'Editor-UI: engine.selectEntity() API-Aufruf implementieren'
...
2. Teste die Funktion aus Prompt 1: 'Editor-UI: engine.selectEntity() API-Aufruf implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Gueltige Eingaben testet
- Logging implementiert
- EXAKTE Ausgabe erzeugt: [SUCCESS] 075-editor-ui-engine-selectentity-api-aufruf-implementieren produced the expected outcome.
...
2. Teste Fehlerbehandlung von 'Editor-UI: engine.selectEntity() API-Aufruf implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Ungueltige Eingaben testet (null, undefined, leere Arrays)
- Exception/Fehler-Rueckgabe erwartet
- EXAKTE Ausgabe: [FAILURE] 075-editor-ui-engine-selectentity-api-aufruf-implementieren correctly handled invalid input.
