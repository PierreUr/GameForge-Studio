# Aufgabe: Editor-UI: EventBus entity:selected Subscription

## Ziel
Diese Aufgabe implementiert die Kernlogik und Tests fuer 'Editor-UI: EventBus entity:selected Subscription'.

**Modul:** UI_Editor_Module
**Task-ID:** 076-editor-ui-eventbus-entity-selected-subscription
**Prioritaet:** Normal
...
3. Wir implementieren: 'Editor-UI: EventBus entity:selected Subscription'
...
2. Teste die Funktion aus Prompt 1: 'Editor-UI: EventBus entity:selected Subscription'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Gueltige Eingaben testet
- Logging implementiert
- EXAKTE Ausgabe erzeugt: [SUCCESS] 076-editor-ui-eventbus-entity-selected-subscription produced the expected outcome.
...
2. Teste Fehlerbehandlung von 'Editor-UI: EventBus entity:selected Subscription'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Ungueltige Eingaben testet (null, undefined, leere Arrays)
- Exception/Fehler-Rueckgabe erwartet
- EXAKTE Ausgabe: [FAILURE] 076-editor-ui-eventbus-entity-selected-subscription correctly handled invalid input.
