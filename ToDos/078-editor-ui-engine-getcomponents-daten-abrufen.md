# Aufgabe: Editor-UI: engine.getComponents() Daten abrufen

## Ziel
Diese Aufgabe implementiert die Kernlogik und Tests fuer 'Editor-UI: engine.getComponents() Daten abrufen'.

**Modul:** UI_Editor_Module
**Task-ID:** 078-editor-ui-engine-getcomponents-daten-abrufen
**Prioritaet:** Normal
...
3. Wir implementieren: 'Editor-UI: engine.getComponents() Daten abrufen'
...
2. Teste die Funktion aus Prompt 1: 'Editor-UI: engine.getComponents() Daten abrufen'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Gueltige Eingaben testet
- Logging implementiert
- EXAKTE Ausgabe erzeugt: [SUCCESS] 078-editor-ui-engine-getcomponents-daten-abrufen produced the expected outcome.
...
2. Teste Fehlerbehandlung von 'Editor-UI: engine.getComponents() Daten abrufen'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Ungueltige Eingaben testet (null, undefined, leere Arrays)
- Exception/Fehler-Rueckgabe erwartet
- EXAKTE Ausgabe: [FAILURE] 078-editor-ui-engine-getcomponents-daten-abrufen correctly handled invalid input.
