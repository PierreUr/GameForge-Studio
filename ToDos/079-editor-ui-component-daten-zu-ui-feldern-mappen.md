# Aufgabe: Editor-UI: Component-Daten zu UI-Feldern mappen

## Ziel
Diese Aufgabe implementiert die Kernlogik und Tests fuer 'Editor-UI: Component-Daten zu UI-Feldern mappen'.

**Modul:** UI_Editor_Module
**Task-ID:** 079-editor-ui-component-daten-zu-ui-feldern-mappen
**Prioritaet:** Normal
...
3. Wir implementieren: 'Editor-UI: Component-Daten zu UI-Feldern mappen'
...
2. Teste die Funktion aus Prompt 1: 'Editor-UI: Component-Daten zu UI-Feldern mappen'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Gueltige Eingaben testet
- Logging implementiert
- EXAKTE Ausgabe erzeugt: [SUCCESS] 079-editor-ui-component-daten-zu-ui-feldern-mappen produced the expected outcome.
...
2. Teste Fehlerbehandlung von 'Editor-UI: Component-Daten zu UI-Feldern mappen'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Ungueltige Eingaben testet (null, undefined, leere Arrays)
- Exception/Fehler-Rueckgabe erwartet
- EXAKTE Ausgabe: [FAILURE] 079-editor-ui-component-daten-zu-ui-feldern-mappen correctly handled invalid input.
