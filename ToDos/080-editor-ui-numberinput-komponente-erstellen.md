# Aufgabe: Editor-UI: NumberInput Komponente erstellen

## Ziel
Diese Aufgabe implementiert die Kernlogik und Tests fuer 'Editor-UI: NumberInput Komponente erstellen'.

**Modul:** UI_Editor_Module
**Task-ID:** 080-editor-ui-numberinput-komponente-erstellen
**Prioritaet:** Normal
...
3. Wir implementieren: 'Editor-UI: NumberInput Komponente erstellen'
...
2. Teste die Funktion aus Prompt 1: 'Editor-UI: NumberInput Komponente erstellen'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Gueltige Eingaben testet
- Logging implementiert
- EXAKTE Ausgabe erzeugt: [SUCCESS] 080-editor-ui-numberinput-komponente-erstellen produced the expected outcome.
...
2. Teste Fehlerbehandlung von 'Editor-UI: NumberInput Komponente erstellen'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Ungueltige Eingaben testet (null, undefined, leere Arrays)
- Exception/Fehler-Rueckgabe erwartet
- EXAKTE Ausgabe: [FAILURE] 080-editor-ui-numberinput-komponente-erstellen correctly handled invalid input.
