# Aufgabe: Editor-UI: Speichern-Button (exportProject) implementieren

## Ziel
Diese Aufgabe implementiert die Kernlogik und Tests fuer 'Editor-UI: Speichern-Button (exportProject) implementieren'.

**Modul:** UI_Editor_Module
**Task-ID:** 087-editor-ui-speichern-button-exportproject-implementieren
**Prioritaet:** Normal
...
3. Wir implementieren: 'Editor-UI: Speichern-Button (exportProject) implementieren'
...
2. Teste die Funktion aus Prompt 1: 'Editor-UI: Speichern-Button (exportProject) implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Gueltige Eingaben testet
- Logging implementiert
- EXAKTE Ausgabe erzeugt: [SUCCESS] 087-editor-ui-speichern-button-exportproject-implementieren produced the expected outcome.
...
2. Teste Fehlerbehandlung von 'Editor-UI: Speichern-Button (exportProject) implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Ungueltige Eingaben testet (null, undefined, leere Arrays)
- Exception/Fehler-Rueckgabe erwartet
- EXAKTE Ausgabe: [FAILURE] 087-editor-ui-speichern-button-exportproject-implementieren correctly handled invalid input.
