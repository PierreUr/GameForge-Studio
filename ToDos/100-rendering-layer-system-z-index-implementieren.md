# Aufgabe: Rendering: Layer-System (z-Index) implementieren

## Ziel
Diese Aufgabe implementiert die Kernlogik und Tests fuer 'Rendering: Layer-System (z-Index) implementieren'.

**Modul:** Rendering_Module
**Task-ID:** 100-rendering-layer-system-z-index-implementieren
**Prioritaet:** Normal
...
3. Wir implementieren: 'Rendering: Layer-System (z-Index) implementieren'
...
2. Teste die Funktion aus Prompt 1: 'Rendering: Layer-System (z-Index) implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Gueltige Eingaben testet
- Logging implementiert
- EXAKTE Ausgabe erzeugt: [SUCCESS] 100-rendering-layer-system-z-index-implementieren produced the expected outcome.
...
2. Teste Fehlerbehandlung von 'Rendering: Layer-System (z-Index) implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Ungueltige Eingaben testet (null, undefined, leere Arrays)
- Exception/Fehler-Rueckgabe erwartet
- EXAKTE Ausgabe: [FAILURE] 100-rendering-layer-system-z-index-implementieren correctly handled invalid input.
