# Aufgabe: Graph: Node-Editor UI-Grundstruktur erstellen

## Ziel
Diese Aufgabe implementiert die Kernlogik und Tests fuer 'Graph: Node-Editor UI-Grundstruktur erstellen'.

**Modul:** Logic_Graph_Module
**Task-ID:** 107-graph-node-editor-ui-grundstruktur-erstellen
**Prioritaet:** Normal
...
3. Wir implementieren: 'Graph: Node-Editor UI-Grundstruktur erstellen'
...
2. Teste die Funktion aus Prompt 1: 'Graph: Node-Editor UI-Grundstruktur erstellen'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Gueltige Eingaben testet
- Logging implementiert
- EXAKTE Ausgabe erzeugt: [SUCCESS] 107-graph-node-editor-ui-grundstruktur-erstellen produced the expected outcome.
...
2. Teste Fehlerbehandlung von 'Graph: Node-Editor UI-Grundstruktur erstellen'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Ungueltige Eingaben testet (null, undefined, leere Arrays)
- Exception/Fehler-Rueckgabe erwartet
- EXAKTE Ausgabe: [FAILURE] 107-graph-node-editor-ui-grundstruktur-erstellen correctly handled invalid input.
