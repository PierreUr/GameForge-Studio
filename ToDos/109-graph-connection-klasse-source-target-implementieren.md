# Aufgabe: Graph: Connection Klasse (source, target) implementieren

## Ziel
Diese Aufgabe implementiert die Kernlogik und Tests fuer 'Graph: Connection Klasse (source, target) implementieren'.

**Modul:** Logic_Graph_Module
**Task-ID:** 109-graph-connection-klasse-source-target-implementieren
**Prioritaet:** Normal
...
3. Wir implementieren: 'Graph: Connection Klasse (source, target) implementieren'
...
2. Teste die Funktion aus Prompt 1: 'Graph: Connection Klasse (source, target) implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Gueltige Eingaben testet
- Logging implementiert
- EXAKTE Ausgabe erzeugt: [SUCCESS] 109-graph-connection-klasse-source-target-implementieren produced the expected outcome.
...
2. Teste Fehlerbehandlung von 'Graph: Connection Klasse (source, target) implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Ungueltige Eingaben testet (null, undefined, leere Arrays)
- Exception/Fehler-Rueckgabe erwartet
- EXAKTE Ausgabe: [FAILURE] 109-graph-connection-klasse-source-target-implementieren correctly handled invalid input.
