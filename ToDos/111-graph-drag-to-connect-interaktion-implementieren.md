# Aufgabe: Graph: Drag-to-Connect Interaktion implementieren

## Ziel
Diese Aufgabe implementiert die Kernlogik und Tests fuer 'Graph: Drag-to-Connect Interaktion implementieren'.

**Modul:** Logic_Graph_Module
**Task-ID:** 111-graph-drag-to-connect-interaktion-implementieren
**Prioritaet:** Normal
...
3. Wir implementieren: 'Graph: Drag-to-Connect Interaktion implementieren'
...
2. Teste die Funktion aus Prompt 1: 'Graph: Drag-to-Connect Interaktion implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Gueltige Eingaben testet
- Logging implementiert
- EXAKTE Ausgabe erzeugt: [SUCCESS] 111-graph-drag-to-connect-interaktion-implementieren produced the expected outcome.
...
2. Teste Fehlerbehandlung von 'Graph: Drag-to-Connect Interaktion implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Ungueltige Eingaben testet (null, undefined, leere Arrays)
- Exception/Fehler-Rueckgabe erwartet
- EXAKTE Ausgabe: [FAILURE] 111-graph-drag-to-connect-interaktion-implementieren correctly handled invalid input.
