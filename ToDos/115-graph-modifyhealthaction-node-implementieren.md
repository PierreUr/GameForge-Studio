# Aufgabe: Graph: ModifyHealthAction Node implementieren

## Ziel
Diese Aufgabe implementiert die Kernlogik und Tests fuer 'Graph: ModifyHealthAction Node implementieren'.

**Modul:** Logic_Graph_Module
**Task-ID:** 115-graph-modifyhealthaction-node-implementieren
**Prioritaet:** Normal
...
3. Wir implementieren: 'Graph: ModifyHealthAction Node implementieren'
...
2. Teste die Funktion aus Prompt 1: 'Graph: ModifyHealthAction Node implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Gueltige Eingaben testet
- Logging implementiert
- EXAKTE Ausgabe erzeugt: [SUCCESS] 115-graph-modifyhealthaction-node-implementieren produced the expected outcome.
...
2. Teste Fehlerbehandlung von 'Graph: ModifyHealthAction Node implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Ungueltige Eingaben testet (null, undefined, leere Arrays)
- Exception/Fehler-Rueckgabe erwartet
- EXAKTE Ausgabe: [FAILURE] 115-graph-modifyhealthaction-node-implementieren correctly handled invalid input.
