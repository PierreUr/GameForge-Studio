# Aufgabe: Graph: CreateEntityAction Node implementieren

## Ziel
Diese Aufgabe implementiert die Kernlogik und Tests fuer 'Graph: CreateEntityAction Node implementieren'.

**Modul:** Logic_Graph_Module
**Task-ID:** 116-graph-createentityaction-node-implementieren
**Prioritaet:** Normal
...
3. Wir implementieren: 'Graph: CreateEntityAction Node implementieren'
...
2. Teste die Funktion aus Prompt 1: 'Graph: CreateEntityAction Node implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Gueltige Eingaben testet
- Logging implementiert
- EXAKTE Ausgabe erzeugt: [SUCCESS] 116-graph-createentityaction-node-implementieren produced the expected outcome.
...
2. Teste Fehlerbehandlung von 'Graph: CreateEntityAction Node implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Ungueltige Eingaben testet (null, undefined, leere Arrays)
- Exception/Fehler-Rueckgabe erwartet
- EXAKTE Ausgabe: [FAILURE] 116-graph-createentityaction-node-implementieren correctly handled invalid input.
