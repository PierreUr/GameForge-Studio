# Aufgabe: Graph: DestroyEntityAction Node implementieren

## Ziel
Diese Aufgabe implementiert die Kernlogik und Tests fuer 'Graph: DestroyEntityAction Node implementieren'.

**Modul:** Logic_Graph_Module
**Task-ID:** 117-graph-destroyentityaction-node-implementieren
**Prioritaet:** Normal
...
3. Wir implementieren: 'Graph: DestroyEntityAction Node implementieren'
...
2. Teste die Funktion aus Prompt 1: 'Graph: DestroyEntityAction Node implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Gueltige Eingaben testet
- Logging implementiert
- EXAKTE Ausgabe erzeugt: [SUCCESS] 117-graph-destroyentityaction-node-implementieren produced the expected outcome.
...
2. Teste Fehlerbehandlung von 'Graph: DestroyEntityAction Node implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Ungueltige Eingaben testet (null, undefined, leere Arrays)
- Exception/Fehler-Rueckgabe erwartet
- EXAKTE Ausgabe: [FAILURE] 117-graph-destroyentityaction-node-implementieren correctly handled invalid input.
