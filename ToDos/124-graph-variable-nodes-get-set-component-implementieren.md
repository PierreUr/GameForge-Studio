# Aufgabe: Graph: Variable-Nodes (Get/Set Component) implementieren

## Ziel
Diese Aufgabe implementiert die Kernlogik und Tests fuer 'Graph: Variable-Nodes (Get/Set Component) implementieren'.

**Modul:** Logic_Graph_Module
**Task-ID:** 124-graph-variable-nodes-get-set-component-implementieren
**Prioritaet:** Normal
...
3. Wir implementieren: 'Graph: Variable-Nodes (Get/Set Component) implementieren'
...
2. Teste die Funktion aus Prompt 1: 'Graph: Variable-Nodes (Get/Set Component) implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Gueltige Eingaben testet
- Logging implementiert
- EXAKTE Ausgabe erzeugt: [SUCCESS] 124-graph-variable-nodes-get-set-component-implementieren produced the expected outcome.
...
2. Teste Fehlerbehandlung von 'Graph: Variable-Nodes (Get/Set Component) implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Ungueltige Eingaben testet (null, undefined, leere Arrays)
- Exception/Fehler-Rueckgabe erwartet
- EXAKTE Ausgabe: [FAILURE] 124-graph-variable-nodes-get-set-component-implementieren correctly handled invalid input.
