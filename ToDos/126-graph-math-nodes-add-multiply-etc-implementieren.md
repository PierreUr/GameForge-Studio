# Aufgabe: Graph: Math-Nodes (Add, Multiply, etc.) implementieren

## Ziel
Diese Aufgabe implementiert die Kernlogik und Tests fuer 'Graph: Math-Nodes (Add, Multiply, etc.) implementieren'.

**Modul:** Logic_Graph_Module
**Task-ID:** 126-graph-math-nodes-add-multiply-etc-implementieren
**Prioritaet:** Normal
...
3. Wir implementieren: 'Graph: Math-Nodes (Add, Multiply, etc.) implementieren'
...
2. Teste die Funktion aus Prompt 1: 'Graph: Math-Nodes (Add, Multiply, etc.) implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Gueltige Eingaben testet
- Logging implementiert
- EXAKTE Ausgabe erzeugt: [SUCCESS] 126-graph-math-nodes-add-multiply-etc-implementieren produced the expected outcome.
...
2. Teste Fehlerbehandlung von 'Graph: Math-Nodes (Add, Multiply, etc.) implementieren'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Ungueltige Eingaben testet (null, undefined, leere Arrays)
- Exception/Fehler-Rueckgabe erwartet
- EXAKTE Ausgabe: [FAILURE] 126-graph-math-nodes-add-multiply-etc-implementieren correctly handled invalid input.
