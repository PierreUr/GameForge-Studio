# Aufgabe: Projekt: ProjectManager Singleton erstellen

## Ziel
Diese Aufgabe implementiert die Kernlogik und Tests fuer 'Projekt: ProjectManager Singleton erstellen'.

**Modul:** Project_Management_Module
**Task-ID:** 127-projekt-projectmanager-singleton-erstellen
**Prioritaet:** Normal
...
3. Wir implementieren: 'Projekt: ProjectManager Singleton erstellen'
...
2. Teste die Funktion aus Prompt 1: 'Projekt: ProjectManager Singleton erstellen'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Gueltige Eingaben testet
- Logging implementiert
- EXAKTE Ausgabe erzeugt: [SUCCESS] 127-projekt-projectmanager-singleton-erstellen produced the expected outcome.
...
2. Teste Fehlerbehandlung von 'Projekt: ProjectManager Singleton erstellen'

**Anweisung:**
Schreibe Jest Unit-Test der:
- Ungueltige Eingaben testet (null, undefined, leere Arrays)
- Exception/Fehler-Rueckgabe erwartet
- EXAKTE Ausgabe: [FAILURE] 127-projekt-projectmanager-singleton-erstellen correctly handled invalid input.
